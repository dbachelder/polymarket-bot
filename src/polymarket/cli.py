...
def main() -> None:
    ...
    btcpc.add_argument("--snapshots-dir", default=None, help="Directory with collector snapshots (defaults to data-dir)")
    ...
    btcpl.add_argument("--snapshots-dir", default=None, help="Directory with collector snapshots (defaults to data-dir)")
