...
MAX_WINDOW_SECONDS = (
    3600  # Maximum 60 minute window (widened from 10 min to catch more close opportunities)
)
...
WINDOW_FALLBACK_TIERS = [300, 600, 1200, 2400, 3600]  # 5min, 10min, 20min, 40min, 60min
